...
def get_column_max(df: pd.DataFrame, column_name: str) -> float:
    """
    get column max from a specific column
    :param df:
    :param column_name:
    :return:
    """
...
def get_column_min(df: pd.DataFrame, column_name: str) -> float:
    """
    get a column min from a specific column
    :param df:
    :param column_name:
    :return:
    """
...
def get_column_mean(df: pd.DataFrame, column_name: str) -> float:
    """
    get mean for a specific column
    :param df:
    :param column_name:
    :return:
    """
...
def get_column_number_of_duplicates(df: pd.DataFrame, column_name: str) -> float:
    """
    count number of duplicates in column
    :param df:
    :param column_name:
    :return:
    """
...
def get_numeric_columns(df: pd.DataFrame) -> List[str]:
    """
    get all columns that have a numeric value
    :param df:
    :return:
    """
...
def get_binary_columns(df: pd.DataFrame) -> List[str]:
    """
    get all columns of binary/boolean value
    :param df:
    :return:
    """
